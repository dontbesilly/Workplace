...
namespace Workplace1c
{
    public class Base : INotifyPropertyChanged
    {
        ...
        private int isServer = 0, isRepository = 0;
        ...
        public int IsServer { get { return isServer; } set { isServer = value; OnPropertyChanged("IsServer"); } }
        public int IsRepository { get { return isRepository; } set { isRepository = value; OnPropertyChanged("IsRepository"); } }
